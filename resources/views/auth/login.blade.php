...
<html lang="en" >
    <head>
        ...
        <script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/js/materialize.min.js') }}"></script>
        <link href="{{ url('http://fonts.googleapis.com/icon?family=Material+Icons') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/css/materialize.min.css') }}">
        <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
        <link rel="stylesheet" type="text/css" href="{{ url('/css/animate.css') }}">
        <link rel="stylesheet" href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css') }}">
            ...
            <h1>
                <small>
                    <h3 class="center main-title animated zoomIn">
                        ...
                        <br>
                        Welcome to<b> Yearbook'17</b> Portal 
                    </h3>
                    <form method="post" action="{{ route('login') }}" class="form main-title center">
                        ...
                        <div class="row" style="margin-bottom: 0px;">
                            ...
                            <div class="input-field col s12 l6 m12 " >
                                ...
                                <label for="rollno">
                                    <h5 style="font-size: 140%;  color: #004d33;">Roll Number (14THXXXXX)</h5>
                                </label>
                            </div>
                            <div class="input-field col s12 l6 m12 ">
                                <input name="password" id="dob" placeholder="Date of Birth" pattern="\d{1,2}-\d{1,2}-\d{4}" type="text" style="margin-top: 5px;" required>
                                <label for="dob">
                                    <h5 style="font-size: 140%; color: #004d33;">Date of Birth (dd-mm-yyyy)</h5>
                                </label>
                            </div>
                        </div>
                        <div class="row">
